package com.rodemtree.project.api.service
...
import com.rodemtree.project.api.dto.MetaDto
...
class KakaoAddressSearchServiceRetryTest extends AbstractIntegrationContainerBaseTest {
    ...
    def "requestAddressSearch retry success"() {
        ...
        then:
        2 * kakaoUriBuilderService.buildUriByAddressService(inputAddress) >> uri
        kakaoApiResult.documentList().get(0).addressName() == inputAddress
